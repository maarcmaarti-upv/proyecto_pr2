...
Cinta = RDK.Item('CRojo')
INCREMENTO_MM = 190
Pimiento = RDK.Item('PiRojo')
SistRefCinta = RDK.Item('PRojo')
...
if Cinta.Valid():
    ...
    nPimiento = RDK.getParam('num_Pimiento_Rojo')
    ...
    RDK.setParam('num_Pimiento_Rojo', nPimiento)
